# ورشة تحليل البيانات باستخدام بايثون

هذا الدليل يلخص خطوات ورشة عمل لتحليل البيانات (بدءاً من استيراد البيانات الخام وحتى بناء اللوحات التفاعلية وتصديرها. الدليل مقسم إلى خطوات منطقية مع الشرح والأكواد البرمجية المناسبة.
